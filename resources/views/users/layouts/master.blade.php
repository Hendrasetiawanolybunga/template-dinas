...
<head>
    ...
    <title> {{ $profil ? $profil->nama_dinas : 'Nama Dinas' }}</title>
    ...
    <!-- Main CSS File -->
    <link href="{{ asset('users/assets/css/main.css') }}" rel="stylesheet">
</head>
...
<body class="index-page">
    ...
    <script src="{{ asset('users/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
